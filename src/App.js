      ...
      <Container style={{ marginTop: "3vh" }}>
        ...
        {wnear > 0 ? (
          <Row style={{ marginTop: "3vh" }}>
            ...
            >
              {" "}
              <Tab eventKey="buywnear" title="Buy Wnear">
                {" "}
                <Buywnear balance={wnear} />
              </Tab>
              <Tab eventKey="Create" title="Donate Now">
                <Creating balance={wnear} />
              </Tab>
              <Tab eventKey="outgoing" title="View Your Donations">
                {" "}
                <Outgoing />
              </Tab>
            </Tabs>
          ...
          <Row style={{ marginTop: "3vh" }}>
            <h1>You Need To Buy Wnear To Donate First</h1>
            <Buywnear />
          </Row>
        ) : (
          <Container>
            ...
            >
              <Card className="text-center justify-content-center">
                ...
                <Card.Body>
                  <Card.Title>Login Into Our Donation Portal</Card.Title>
